...
const KunjunganMingguan = ({ kunjunganMingguan }) => {
    ...
    useEffect(() => {
        ...
        const filteredData = kunjunganMingguan.slice(0, 8).reverse(); // Ambil 8 minggu terakhir dan urutkan
                ...
                <div className="max-w-full mx-auto w-full">
                    <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg w-full">
                        <div className="p-5 text-gray-900 dark:text-gray-100 w-full">
                            <div>
                                <h1 className="uppercase text-center font-bold text-xl">Kunjungan Mingguan</h1>
...
export default KunjunganMingguan;

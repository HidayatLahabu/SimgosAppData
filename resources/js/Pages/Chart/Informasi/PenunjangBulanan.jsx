...
const PenunjangBulanan = ({ penunjangBulanan }) => {
    ...
    useEffect(() => {
        ...
        const filteredValidData = penunjangBulanan
                ...
                datasets: [
                    {
                        ...
                        backgroundColor: "rgba(192, 222, 24)",
                        borderColor: "rgba(192, 222, 24)",
                        borderWidth: 1,
                    },
                ],
            },
        ...
        <div className="p-5 w-full">
            <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg w-full">
                <div className="p-5 text-gray-900 dark:text-gray-100">
                    <h1 className="uppercase text-center font-bold text-xl">Layanan Penunjang Per Unit Tahun Ini</h1>
...
export default PenunjangBulanan;

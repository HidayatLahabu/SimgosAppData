...
const LaporanRl314Lalu = ({ tahunLalu, laporanRl314Lalu }) => {
    ...
    useEffect(() => {
        ...
        if (!laporanRl314Lalu || laporanRl314Lalu.length === 0) return;

        // Filter data dengan total pasien lebih dari 100
        const filteredData = laporanRl314Lalu.filter((item) => {
        ...
        <div className="p-5 w-full">
            <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg w-full">
                <div className="p-5 text-gray-900 dark:text-gray-100">
                    <h1 className="uppercase text-center font-bold text-xl">Laporan RL 3.14 - Rujukan {tahunLalu}</h1>
...
export default LaporanRl314Lalu;

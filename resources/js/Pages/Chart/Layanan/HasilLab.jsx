...
const Laboratorium = ({ hasilLabTahunIni, hasilLabTahunLalu, tahunIni, tahunLalu }) => {
    ...
    useEffect(() => {
        ...
        hasilLabTahunIni.forEach((item) => {
            tahunIniCounts[item.bulan - 1] = item.total;
        });

        hasilLabTahunLalu.forEach((item) => {
                ...
                datasets: [
                    {
                        ...
                        backgroundColor: "rgba(21, 73, 194, 0.5)",
                        borderWidth: 2,
                        fill: true,
                        tension: 0.4,
                    },
                    {
                        ...
                        backgroundColor: "rgba(7, 245, 166, 0.3)",
                        borderWidth: 2,
                        fill: true,
                        tension: 0.4,
                    },
    ...
    }, [hasilLabTahunIni, hasilLabTahunLalu]);
                ...
                <div className="max-w-full mx-auto w-full">
                    <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg w-full">
                        <div className="p-5 text-gray-900 dark:text-gray-100 w-full">
                            <div>
                                <h1 className="uppercase text-center font-bold text-xl">Hasil Laboratorium Tahun {tahunIni} dan {tahunLalu}</h1>

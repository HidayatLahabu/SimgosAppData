                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-200 dark:bg-indigo-900 border border-gray-500 dark:border-gray-600">
                                    ...
                                    <thead className="text-sm font-bold text-gray-700 uppercase bg-gray-50 dark:bg-indigo-900 dark:text-yellow-500">
                                        <tr>
                                            ...
                                            <th className="px-3 py-2 border border-gray-500 dark:border-gray-600">AUTHOR</th>
                                            <th className="px-3 py-2 border border-gray-500 dark:border-gray-600">TITLE</th>
                                        ...
                                        {dataTable.data.length > 0 ? (
                                            dataTable.data.map((data, index) => (
                                                <tr key={`${data.nopen}-${index}`}
                                                    ...
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{data.author}</td>
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{data.title}</td>

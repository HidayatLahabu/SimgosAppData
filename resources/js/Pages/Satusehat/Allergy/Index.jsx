                                            ...
                                            <th colSpan={8} className="px-3 py-2">
                                                <div className="flex items-center space-x-2">
                                                    <TextInput
                                                        ...
                                                        placeholder="Cari data berdasarkan patient atau ref id"
                                                        onChange={e => onInputChange('search', e)}
                                                        onKeyPress={e => onKeyPress('search', e)}
                                                    />
                                                    <ButtonTime href={route("allergy.filterByTime", "hariIni")} text="Hari Ini" />
                                                    <ButtonTime href={route("allergy.filterByTime", "mingguIni")} text="Minggu Ini" />
                                                    <ButtonTime href={route("allergy.filterByTime", "bulanIni")} text="Bulan Ini" />
                                                    <ButtonTime href={route("allergy.filterByTime", "tahunIni")} text="Tahun Ini" />
                                                </div>
                                            </th>
                                        </tr>
                                    </TableHeader>
                                        ...
                                        {dataTable.data.length > 0 ? (
                                            dataTable.data.map((data, index) => (
                                                <TableRow key={data.refId} isEven={index % 2 === 0}>
                                                    ...
                                                    <TableCell>{data.clinicalStatus}</TableCell>

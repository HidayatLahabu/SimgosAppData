                                        ...
                                        {dataTable.data.length > 0 ? (
                                            dataTable.data.map((dataTable, index) => (
                                                <tr key={`${dataTable.id}-${index}`}
                                                    ...
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{dataTable.id}</td>
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{dataTable.subject}</td>
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{dataTable.refId}</td>
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{dataTable.nopen}</td>
                                                    <td className="px-3 py-3 border border-gray-500 dark:border-gray-600">{dataTable.sendDate}</td>
                                                </tr>
                                            ))
                                        ) : (

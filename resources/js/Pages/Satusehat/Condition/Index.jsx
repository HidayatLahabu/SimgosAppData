                    ...
                    <div className="bg-white dark:bg-indigo-900 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-5 text-gray-900 dark:text-gray-100 dark:bg-indigo-950">
                            <div className="overflow-auto w-full">
                                <h1 className="uppercase text-center font-bold text-2xl pb-2">Data Condition {header} {totalCount} {text}</h1>
                                        ...
                                        <tr>
                                            <th colSpan={8} className="px-3 py-2">
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <ButtonTime href={route("condition.filterByTime", "hariIni")} text="Hari Ini" />
                                                    <ButtonTime href={route("condition.filterByTime", "mingguIni")} text="Minggu Ini" />
                                                    <ButtonTime href={route("condition.filterByTime", "bulanIni")} text="Bulan Ini" />
                                                    <ButtonTime href={route("condition.filterByTime", "tahunIni")} text="Tahun Ini" />
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>

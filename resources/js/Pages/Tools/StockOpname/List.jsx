                                        ...
                                        {stockDetail.data.length > 0 ? (
                                            stockDetail.data.map((stockDetail, index) => (
                                                <tr key={stockDetail.id} className="bg-white border-b dark:bg-indigo-950 dark:border-gray-500">
                                                    <td className="px-3 py-3">{stockDetail.idSo}</td>
                                                    <td className="px-3 py-3">{stockDetail.ruangan}</td>
                                                    <td className="px-3 py-3">{stockDetail.idBarang}</td>
                                                    ...
                                                    <td className="px-3 py-3 text-right">{stockDetail.sistem}</td>
                                                </tr>
                                            ))
                                        ) : (
                                            <tr className="bg-white border-b dark:bg-indigo-950 dark:border-gray-500">
                                                <td colSpan="11" className="px-3 py-3 text-center">Tidak ada data yang dapat ditampilkan</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>

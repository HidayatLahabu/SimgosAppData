...
export default function CetakRekap() {
    ...
    const onSubmit = (e) => {
        ...
        window.open(route("layananLab.hasilRekap") + "?" + queryString, "_blank");
    };
        ...
        <div className="pt-2">
            <div className="max-w-8xl mx-auto sm:px-6 lg:px-5">
                <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    >
                        <h1 className="uppercase text-center font-bold text-xl pt-2 text-white">
                            Cetak Rekap Tindakan Laboratorium
                        </h1>
                        ...
                        <div className="mt-4 flex space-x-4">
                            <div className="flex-1">
                                ...
                                <TextInput
                                    ...
                                    onChange={(e) =>
                                        setData({ ...data, dari_tanggal: e.target.value })
                                    }
                                />
                            </div>
                            ...
                            <div className="flex-1">
                                ...
                                <TextInput
                                    ...
                                    onChange={(e) =>
                                        setData({ ...data, sampai_tanggal: e.target.value })
                                    }
                                />
                            </div>
                        </div>

                                        ...
                                        {dataTable.data.length > 0 ? (
                                            dataTable.data.map((data, index) => (
                                                <TableRow key={data.nomor} isEven={index % 2 === 0}>
                                                    ...
                                                    <TableCell>{data.statusOrder === 2 ? 'Sudah Final' : data.statusOrder === 1 ? 'Belum Final' : 'Batal'}</TableCell>
                                                    <TableCell>{data.statusHasil === 1 ? 'Sudah Final' : 'Belum Ada Hasil'}</TableCell>

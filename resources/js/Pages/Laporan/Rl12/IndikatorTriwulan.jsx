...
export default function IndikatorTriwulan({
    tahunIni,
    ...
    const renderTable = (tahun, statistikTriwulan) => (
        <Table>
            <TableHeader>
                <tr>
                    <TableHeaderCell>TRIWULAN</TableHeaderCell>
            ...
            <tbody>
                {statistikTriwulan?.length > 0 ? (
                    statistikTriwulan.map((data, index) => (
                        <TableRow key={`${data.TAHUN}-${data.TRIWULAN}`} isEven={index % 2 === 0}>
                            <TableCell>{data.TRIWULAN}</TableCell>
                    ...
                    <div className="p-5 text-gray-900 dark:text-gray-100 dark:bg-indigo-950">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                {renderTable(tahunIni, statistikTriwulanIni)}
                            </div>
                            {/* Tabel Tahun Lalu */}
                            <div>
                                <h2 className="text-center font-bold text-lg mb-2 text-indigo-700 dark:text-gray-200">
                                ...
                                {renderTable(tahunLalu, statistikTriwulanLalu)}
                            </div>
                        </div>
                    </div>
                </div>

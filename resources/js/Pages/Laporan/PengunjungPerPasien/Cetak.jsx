...
export default function Cetak({
    ...
    useEffect(() => {
        ...
        setData(prevData => ({
            ...prevData,
            dari_tanggal: formattedCurrentDate,
    ...
    const onSubmit = (e) => {
        ...
        window.open(route("pengunjungPerPasien.print") + "?" + queryString, "_blank");
    };
        ...
        <div className="pt-2">
            <div className="max-w-8xl mx-auto sm:px-6 lg:px-5 pb-2">
                <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    >
                        <h1 className="uppercase text-center font-bold text-2xl pt-2 text-white">Cetak Laporan Pengunjung Per Pasien</h1>

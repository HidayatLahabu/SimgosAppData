...
export default function Print({ items, dariTanggal, sampaiTanggal }) {
                                ...
                                <table className="w-full text-[10px] text-left rtl:text-right text-gray-500 dark:text-gray-900 mt-4 border border-gray-500">
                                    <thead className="text-[10px] font-bold text-gray-900 bg-gray-300 dark:text-gray-900 border border-gray-500">
                                        <tr>
                                            ...
                                            <th className="px-3 py-2 border border-gray-500 border-solid text-center">TANGGAL REGISTRASI</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid text-center">TANGGAL KELUAR</th>
                                            ...
                                            <th className="px-3 py-2 border border-gray-500 border-solid">NOMOR KARTU</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid">SEP</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid">LOS</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid">TARIF</th>

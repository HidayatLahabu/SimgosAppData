...
import DetailHasilRad from './DetailHasilRad';
...
export default function DetailRad({ auth, detailRad, detailHasilRad }) {
    ...
    const detailData = Object.keys(detailRad).map((key) => ({
        uraian: key,
        value: detailRad[key],
    }));
                        ...
                        <div className="p-5 text-gray-900 dark:text-gray-100 dark:bg-indigo-950">
                            <div className="overflow-auto w-full">
                                <div className="relative flex items-center justify-between pb-2">
                                    ...
                                    <h1 className="absolute left-1/2 transform -translate-x-1/2 uppercase font-bold text-2xl">DATA DETAIL KUNJUNGAN RADIOLOGI</h1>
                                </div>

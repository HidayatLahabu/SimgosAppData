                    ...
                    <div className="bg-white dark:bg-indigo-900 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-5 text-gray-900 dark:text-gray-100 dark:bg-indigo-950">
                            <div className="overflow-auto w-full">
                                <h1 className="uppercase text-center font-bold text-2xl pb-2">Data Antrian Ruangan {header} {totalCount} {text}</h1>
                                        ...
                                        <tr>
                                            <th colSpan={7} className="px-3 py-2">
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <ButtonTime href={route("antrian.filterByStatus", "batal")} text="Batal" />
                                                    <ButtonTime href={route("antrian.filterByStatus", "belumDiterima")} text="Belum Diterima" />
                                                    <ButtonTime href={route("antrian.filterByStatus", "diterima")} text="Diterima" />
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>

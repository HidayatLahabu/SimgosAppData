...
export default function Cetak({ ruangan = [] }) {
    ...
    const handleStatusChange = (selectedOption) => {
        if (selectedOption && selectedOption.value) {
            setData(prevData => ({ ...prevData, statusMutasi: selectedOption.value }));
        } else {
            setData(prevData => ({ ...prevData, statusMutasi: '' }));  // Atau handling sesuai kebutuhan
        }
    };
    ...
    const onSubmit = (e) => {
        ...
        window.open(route("mutasi.print") + "?" + queryString, "_blank");
    };
                ...
                <div className="bg-white dark:bg-indigo-950 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    >
                        ...
                        <div className="mt-4 flex space-x-4">
                            ...
                            <div className="flex-1">
                                <InputLabel htmlFor="statusMutasi" value="Status Mutasi" />
                                <SelectTwoInput
                                    id="statusMutasi"
                                    name="statusMutasi"
                                    className="mt-1 block w-full"

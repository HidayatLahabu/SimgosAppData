                ...
                <div className="absolute left-0 mt-1 w-full rounded-md shadow-lg bg-white dark:bg-indigo-950 z-10">
                    <div className="rounded-md shadow-xs">
                        <div className="py-1">
                            ...
                            <ResponsiveNavLink href={route('kegiatanPasienKeluarRanap.index')}>Pasien Keluar RI</ResponsiveNavLink>
                            ...
                            <ResponsiveNavLink href={route('kegiatanRanap.index')}>Rekap Kegiatan RI Per Unit</ResponsiveNavLink>
                            <ResponsiveNavLink href={route('kegiatanRanap.index')}>Rekap Pasien Keluar RI</ResponsiveNavLink>
                            ...
                            <ResponsiveNavLink href={route('respondTImeIgd.index')}>Respond Time IGD</ResponsiveNavLink>
                            <ResponsiveNavLink href={route('monitoringKegiatan.index')}>Monitoring Kegiatan</ResponsiveNavLink>
                            <ResponsiveNavLink href={route('monitoringKegiatanRekap.index')}>Monitoring Kegiatan Rekap</ResponsiveNavLink>
                        </div>
                    </div>
                </div>
            )}

...
export default function ResponsiveNavBpjs() {
            ...
            {isOpen && (
                <div className="absolute left-0 mt-1 w-full rounded-md shadow-lg bg-white dark:bg-indigo-950 z-10">
                    <div className="rounded-md shadow-xs">
                        <div className="py-1">
                            <ResponsiveNavLink href={route('pesertaBpjs.index')}>Peserta</ResponsiveNavLink>
                            <ResponsiveNavLink href={route('kunjunganBpjs.index')}>Kunjungan</ResponsiveNavLink>
                            ...
                            <ResponsiveNavLink href={route('rujukanBpjs.index')}>Rujukan Masuk</ResponsiveNavLink>
                        </div>
                    </div>
                </div>
            )}

...
class PasienKeluarRanapController extends Controller
{
    public function index()
    {
        ...
        $data = DB::connection('mysql10')->select('CALL laporan.LaporanPasienKeluar(?, ?, ?, ?, ?, ?)', [$tgl_awal, $tgl_akhir, 0, '%', 3, 0]);
        ...
        return inertia("Laporan/PasienKeluarRanap/Index", [
    ...
    public function print(Request $request)
    {
        ...
        // Panggil prosedur yang telah dibuat
        $data = DB::connection('mysql10')->select('CALL laporan.LaporanPasienKeluar(?, ?, ?, ?, ?, ?)', [$dariTanggal, $sampaiTanggal, 0, $ruangan, 3, $caraBayar]);
        ...
        return inertia("Laporan/PasienKeluarRanap/Print", [
            'data' => $filteredData,

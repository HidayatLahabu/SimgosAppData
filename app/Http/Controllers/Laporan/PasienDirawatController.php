...
class PasienDirawatController extends Controller
{
    public function index()
    {
        ...
        $data = DB::connection('mysql10')->select('CALL laporan.LaporanPasienDirawat(?, ?, ?, ?, ?, ?)', [$tgl_awal, $tgl_akhir, 0, '%', 3, 0]);
        ...
        return inertia("Laporan/PasienDirawat/Index", [
    ...
    public function print(Request $request)
    {
        ...
        // Panggil prosedur yang telah dibuat
        $data = DB::connection('mysql10')->select('CALL laporan.LaporanPasienDirawat(?, ?, ?, ?, ?, ?)', [$dariTanggal, $sampaiTanggal, 0, $ruangan, 3, $caraBayar]);
        ...
        return inertia("Laporan/PasienDirawat/Print", [
            'data' => $filteredData,

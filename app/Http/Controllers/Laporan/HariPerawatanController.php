...
class HariPerawatanController extends Controller
{
    public function index()
    {
        ...
        $data = DB::connection('mysql10')->select('CALL laporan.LaporanHariPerawatan(?, ?, ?, ?, ?, ?)', [$tgl_awal, $tgl_akhir, 0, '%', 3, 0]);
        ...
        return inertia("Laporan/HariPerawatan/Index", [
    ...
    public function print(Request $request)
    {
        ...
        // Panggil prosedur yang telah dibuat
        $data = DB::connection('mysql10')->select('CALL laporan.LaporanHariPerawatan(?, ?, ?, ?, ?, ?)', [$dariTanggal, $sampaiTanggal, 0, $ruangan, 3, $caraBayar]);
        ...
        return inertia("Laporan/HariPerawatan/Print", [
            'data' => $filteredData,

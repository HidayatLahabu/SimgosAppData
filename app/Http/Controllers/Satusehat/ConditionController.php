...
use App\Models\SatusehatConditionModel;
...
class ConditionController extends Controller
{
    ...
    {
        // Define base query
        $query = SatusehatConditionModel::orderByDesc('id')->orderByDesc('sendDate');
    ...
    public function detail($id)
    {
        ...
        if (!$query) {
            ...
            return redirect()->route('condition.index')->with('error', 'Encounter not found.');
        }

        // Return Inertia view with the encounter data
        return inertia("Satusehat/Condition/Detail", [
            'detail' => $query,
        ]);
    }
}